...
_term_install_wrappers() {
  local t
  for t in claude codex grok kimi muse opencode; do
...
# Ein spaeter in der ~/.bashrc definiertes claude()/codex()/grok()/kimi()/muse()/opencode() (z. B. der
