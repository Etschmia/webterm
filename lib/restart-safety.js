...
export function restartRisks(controlGroup, processes, panePids, serverPid) {
  ...
  return processes.filter(p => {
    // Zwischen Prozessliste und cgroup-Lesen beendete Prozesse (auch der eigene
    // `ps`-Aufruf der Pruefung) koennen nichts mehr gefaehrden. Nur ein noch
    // existierender Prozess ohne lesbare Gruppe bleibt unten ein Risiko.
