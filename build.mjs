...
// Derselbe Inhalts-Hash aller Runtime-Dateien wie in Server und deploy/update.
// Er erkennt auch uncommittierte Aenderungen sowie hinzugefuegte/entfernte Module.
const STAMP = backendVersion(__dirname);
